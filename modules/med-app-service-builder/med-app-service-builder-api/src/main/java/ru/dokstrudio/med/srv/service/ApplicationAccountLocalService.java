...
/**
 * Provides the local service interface for ApplicationAccount. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ApplicationAccountLocalServiceUtil
...
public interface ApplicationAccountLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ApplicationAccountLocalServiceUtil} to access the application account local service. Add custom service methods to {@link ru.dokstrudio.med.srv.service.impl.ApplicationAccountLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ApplicationAccount addApplicationAccount(
	...
	*/
	public ApplicationAccount createApplicationAccount(long accountTypeId);
	...
	*/
	...
	public ApplicationAccount deleteApplicationAccount(long accountTypeId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ApplicationAccount deleteApplicationAccount(
		ApplicationAccount applicationAccount);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ApplicationAccount fetchApplicationAccount(long accountTypeId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ApplicationAccount getApplicationAccount(long accountTypeId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ApplicationAccount updateApplicationAccount(
		ApplicationAccount applicationAccount);
}