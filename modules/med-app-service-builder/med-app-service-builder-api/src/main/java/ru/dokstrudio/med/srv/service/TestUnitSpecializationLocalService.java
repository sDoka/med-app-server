...
/**
 * Provides the local service interface for TestUnitSpecialization. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TestUnitSpecializationLocalServiceUtil
...
public interface TestUnitSpecializationLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestUnitSpecializationLocalServiceUtil} to access the test unit specialization local service. Add custom service methods to {@link ru.dokstrudio.med.srv.service.impl.TestUnitSpecializationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
