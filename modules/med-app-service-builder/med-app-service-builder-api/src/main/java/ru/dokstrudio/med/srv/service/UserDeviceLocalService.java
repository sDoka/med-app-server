...
/**
 * Provides the local service interface for UserDevice. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserDeviceLocalServiceUtil
...
public interface UserDeviceLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserDeviceLocalServiceUtil} to access the user device local service. Add custom service methods to {@link ru.dokstrudio.med.srv.service.impl.UserDeviceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserDevice> getUserDevices(int start, int end);
	...
	*/
	...
	public UserDevice deleteUserDevice(long deviceId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public UserDevice deleteUserDevice(UserDevice userDevice);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserDevice fetchUserDevice(long deviceId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserDevice getUserDevice(long deviceId) throws PortalException;
