...
/**
 * Provides the local service interface for TestUnit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TestUnitLocalServiceUtil
...
public interface TestUnitLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestUnitLocalServiceUtil} to access the test unit local service. Add custom service methods to {@link ru.dokstrudio.med.srv.service.impl.TestUnitLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
