...
/**
 * Provides the local service interface for ApplicationUsage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ApplicationUsageLocalServiceUtil
...
public interface ApplicationUsageLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ApplicationUsageLocalServiceUtil} to access the application usage local service. Add custom service methods to {@link ru.dokstrudio.med.srv.service.impl.ApplicationUsageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
