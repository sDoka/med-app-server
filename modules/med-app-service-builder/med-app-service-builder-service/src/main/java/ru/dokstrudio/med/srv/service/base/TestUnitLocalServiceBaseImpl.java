...
public abstract class TestUnitLocalServiceBaseImpl extends BaseLocalServiceImpl
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TestUnit.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return testUnitPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("ru.dokstrudio.med.srv.model.TestUnit",
			testUnitLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"ru.dokstrudio.med.srv.model.TestUnit");
	}
