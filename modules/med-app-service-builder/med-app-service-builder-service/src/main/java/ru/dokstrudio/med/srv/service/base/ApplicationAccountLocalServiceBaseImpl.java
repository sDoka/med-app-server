...
import ru.dokstrudio.med.srv.service.ApplicationAccountLocalService;
...
/**
 * Provides the base implementation for the application account local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ru.dokstrudio.med.srv.service.impl.ApplicationAccountLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class ApplicationAccountLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ApplicationAccountLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link ru.dokstrudio.med.srv.service.ApplicationAccountLocalServiceUtil} to access the application account local service.
	 */
	...
	public ApplicationAccount createApplicationAccount(long accountTypeId) {
		return applicationAccountPersistence.create(accountTypeId);
	}
	...
	public ApplicationAccount deleteApplicationAccount(long accountTypeId)
		...
		return applicationAccountPersistence.remove(accountTypeId);
	}
	...
	public ApplicationAccount deleteApplicationAccount(
		ApplicationAccount applicationAccount) {
		return applicationAccountPersistence.remove(applicationAccount);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ApplicationAccount.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return applicationAccountPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return applicationAccountPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ApplicationAccount fetchApplicationAccount(long accountTypeId) {
		return applicationAccountPersistence.fetchByPrimaryKey(accountTypeId);
	}
	...
	public ApplicationAccount getApplicationAccount(long accountTypeId)
		throws PortalException {
		return applicationAccountPersistence.findByPrimaryKey(accountTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(applicationAccountLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ApplicationAccount.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("accountTypeId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(applicationAccountLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ApplicationAccount.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return applicationAccountLocalService.deleteApplicationAccount((ApplicationAccount)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return applicationAccountPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("ru.dokstrudio.med.srv.model.ApplicationAccount",
			applicationAccountLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"ru.dokstrudio.med.srv.model.ApplicationAccount");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ApplicationAccountLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = applicationAccountPersistence.getDataSource();
	...
	@BeanReference(type = ApplicationAccountLocalService.class)
	protected ApplicationAccountLocalService applicationAccountLocalService;
