...
/**
 * Provides the local service interface for TestItemQuestion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TestItemQuestionLocalServiceUtil
...
public interface TestItemQuestionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestItemQuestionLocalServiceUtil} to access the test item question local service. Add custom service methods to {@link ru.dokstudio.service.impl.TestItemQuestionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public TestItemQuestion addTestItemQuestion(
	...
	*/
	...
	public TestItemQuestion deleteTestItemQuestion(long questionId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public TestItemQuestion deleteTestItemQuestion(
		TestItemQuestion testItemQuestion);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TestItemQuestion getQuestionByQuestionNumber(long questionNumber)
		throws SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TestItemQuestion getTestItemQuestion(long questionId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public TestItemQuestion updateTestItemQuestion(
		TestItemQuestion testItemQuestion);
}