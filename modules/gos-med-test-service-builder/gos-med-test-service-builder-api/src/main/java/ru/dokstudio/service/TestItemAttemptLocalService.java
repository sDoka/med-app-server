...
/**
 * Provides the local service interface for TestItemAttempt. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TestItemAttemptLocalServiceUtil
...
public interface TestItemAttemptLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestItemAttemptLocalServiceUtil} to access the test item attempt local service. Add custom service methods to {@link ru.dokstudio.service.impl.TestItemAttemptLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
